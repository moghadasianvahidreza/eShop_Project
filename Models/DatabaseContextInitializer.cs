...
namespace Models
{
	public class DatabaseContextInitializer : DropCreateDatabaseIfModelChanges<DatabaseContext>
	{
		protected override void Seed(DatabaseContext context)
		{
			...
			myProductComments.Add(new ProductComment() { ProductCommentId = 1, Name = "Farzaneh Ghafari", EmailAddress = "farzaneh@gmail.com", Comment = "سلام دوستان من این محصول رو به شما دوستان عزیزم پیشنهاد می کنیم", CreateDate = System.DateTime.Now, Website = "", ParentId = null, ProductId = 2 });
			myProductComments.Add(new ProductComment() { ProductCommentId = 2, Name = "Eli Hoseini", EmailAddress = "eli@gmail.com", Comment = "سلام وحید رض جان امیدوارم که به سلامتی از این محصول استفاده کنی", CreateDate = System.DateTime.Now, Website = "", ParentId = 1, ProductId = 2 });
			myProductComments.Add(new ProductComment() { ProductCommentId = 3, Name = "Aydin Ghani", EmailAddress = "aydin@gmail.com", Comment = "سلام دوستان منم هم این محصول رو به دوستان خوبم پیشنهاد می کنم ما خانوادگی این محصول رو خریداری کردیم", CreateDate = System.DateTime.Now, Website = "", ParentId = null, ProductId = 2 });
