...
namespace Models
{
	public class DatabaseContextInitializer : DropCreateDatabaseIfModelChanges<DatabaseContext>
	{
		protected override void Seed(DatabaseContext context)
		{
			...
			myProductGalleries.Add(new ProductGallery() { GalleryId = 2, ProductId = 1, Title = "تصویر شماره ۱", ImageName = System.IO.Path.GetFileName("C:/Users/vahid reza/source/repos/eShop_Project/Images/ProductImages/Thumbnail/2.jpg") });
			myProductGalleries.Add(new ProductGallery() { GalleryId = 3, ProductId = 1, Title = "تصویر شماره 2", ImageName = System.IO.Path.GetFileName("C:/Users/vahid reza/source/repos/eShop_Project/Images/ProductImages/Thumbnail/3.jpg") });
			myProductGalleries.Add(new ProductGallery() { GalleryId = 3, ProductId = 1, Title = "تصویر شماره 2", ImageName = System.IO.Path.GetFileName("C:/Users/vahid reza/source/repos/eShop_Project/Images/ProductImages/Thumbnail/4.jpg") });
			myProductGalleries.Add(new ProductGallery() { GalleryId = 4, ProductId = 2, Title = "تصویر شماره3", ImageName = System.IO.Path.GetFileName("C:/Users/vahid reza/source/repos/eShop_Project/Images/ProductImages/Thumbnail/12.jpg") });
			myProductGalleries.Add(new ProductGallery() { GalleryId = 5, ProductId = 2, Title = "تصویر شماره 4", ImageName = System.IO.Path.GetFileName("C:/Users/vahid reza/source/repos/eShop_Project/Images/ProductImages/Thumbnail/13.jpg") });
			myProductGalleries.Add(new ProductGallery() { GalleryId = 6, ProductId = 2, Title = "تصویر شماره 5", ImageName = System.IO.Path.GetFileName("C:/Users/vahid reza/source/repos/eShop_Project/Images/ProductImages/Thumbnail/14.jpg") });
			...
			myProductComments.Add(new ProductComment() { ProductCommentId = 4, Name = "Farzaneh Ghafari", EmailAddress = "farzaneh@gmail.com", Comment = "سلام دوستان من این محصول رو به شما دوستان عزیزم پیشنهاد می کنیم", CreateDate = System.DateTime.Now, Website = "", ParentId = null, ProductId = 2 });
			myProductComments.Add(new ProductComment() { ProductCommentId = 5, Name = "Eli Hoseini", EmailAddress = "eli@gmail.com", Comment = "سلام وحید رض جان امیدوارم که به سلامتی از این محصول استفاده کنی", CreateDate = System.DateTime.Now, Website = "", ParentId = 4, ProductId = 2 });
			myProductComments.Add(new ProductComment() { ProductCommentId = 6, Name = "Aydin Ghani", EmailAddress = "aydin@gmail.com", Comment = "سلام دوستان منم هم این محصول رو به دوستان خوبم پیشنهاد می کنم ما خانوادگی این محصول رو خریداری کردیم", CreateDate = System.DateTime.Now, Website = "", ParentId = null, ProductId = 2 });
